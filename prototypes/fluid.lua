...
toxicsludge.icon = "__PollutionSolutions2__/graphics/icons/fluid/toxicsludge.png"
...
pollution.icon = "__PollutionSolutions2__/graphics/icons/fluid/pollution.png"
